...
import { RegisterFocus, RegisterInputs, RegisterValidChecks, User } from '../../utils/interfaces';
import './styles.css';
...
const RegisterForm: React.FC<Props> = ({ renderConstants, setRender, createUser, setUserLoggedIn }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const userData = await createUser({variables: {
                username: registerInputs.username,
                email: registerInputs.email,
                password: registerInputs.password
            }});
            if (userData.data.createUser) {
