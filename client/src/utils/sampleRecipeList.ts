...
export const sampleRecipeList: Recipe[] = [
    {
        _id: '123',
        title: 'Babish Chicken Parm1',
        video: {
            _id: '123',
